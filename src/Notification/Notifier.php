...
class Notifier
{
	...
	public function __construct(Catalog $catalog, string $serviceName, LoggerInterface $logger)
	{
	...
	{
	    /** @var \Oka\NotifierBundle\Notification\Notification $notification */
	    ...
	    try {
	        ...
	        $this->logger->error(sprintf(
	            'Notifier SDK: %s: %s (uncaught exception) at %s line %s',
	            get_class($e),
	            $e->getMessage(),
	            $e->getFile(),
	            $e->getLine()
